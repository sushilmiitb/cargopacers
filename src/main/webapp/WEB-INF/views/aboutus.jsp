			...
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<div class="text-center page-header">
							<p>
							<h2>A hi-tech, reliable and easy way to ship cargo.</h2>
							</p>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-md-10 col-xs-offset-1">
						...
						<h2>
							<span class="label label-default"> Our Vision </span>
						</h2>
						<div class="well well-lg">
							<p>Has logistics been an impediment more than an enabler for
								your business? Have you found yourself at the receiving end of
								price fluctuations from transporters without being guaranteed
								proper service? And even after giving the load, do you face
								major fluctuations in delivery times and quality of service?</p>
						</div>
						<div class="rule pad"></div>

						<h2>
							<span class="label label-default"> About the Company </span>
						</h2>
						<div class="well well-lg">
							<p>
						...
						<h2>
							<span class="label label-default">Our Team</span>
						</h2>
						Team
						...
						<p>
							Excited to join us? <a href="#"> Careers </a>
						</p>
